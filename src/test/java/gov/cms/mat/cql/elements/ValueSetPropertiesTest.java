...
class ValueSetPropertiesTest {
  ...
  void setToFhir_ConvertUrnToLink() {
    ...
    ValueSetProperties valueSetProperties =
        ValueSetProperties.builder()
    ...
    assertEquals(
        "valueset \"Aortic Dissection\": 'http://cts.nlm.nih.gov/fhir/ValueSet/2.16.840.1.113883.17.4077.3.1026'",
        cql);
  }
