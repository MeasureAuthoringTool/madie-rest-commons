...
public class CqlConversionError extends CqlConversionBase {
  ...
  @EqualsAndHashCode.Exclude String targetIncludeLibraryId;
  @EqualsAndHashCode.Exclude String libraryId;

  @EqualsAndHashCode.Exclude String targetIncludeLibraryVersionId;
  @EqualsAndHashCode.Exclude String libraryVersion; // added to
