...
public final class ServletLogging {
  ...
  public static void logIncomingRequest(
      String requestURI, String queryString, String method, String headers, String body) {
  ...
  public static void logIncomingResponse(
      String status, long executionTime, String headers, String body) {
    if (log.isDebugEnabled()) {
  ...
  public static void logOutgoingRequest(
      URI requestURI, String method, String headers, String body) {
    if (log.isDebugEnabled()) {
  ...
  public static void logOutgoingResponse(
      String statusCode, String statusText, long executionTime, String headers, String body) {
    if (log.isDebugEnabled()) {
